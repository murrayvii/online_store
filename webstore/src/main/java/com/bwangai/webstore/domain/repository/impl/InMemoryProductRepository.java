package com.bwangai.webstore.domain.repository.impl;

/**
 * Created by bwangai on 1/5/17.
 * in normal circumstances DB goes here
...
public class InMemoryProductRepository implements ProductRepository {
    ...
    public InMemoryProductRepository() {
        Product iphone = new Product("P1234", "iPhone 5s", new BigDecimal(85000));
        iphone.setDescription("Apple iPhone 5s smartphone with 4.00-inch 640x1136 display and 8-megapixel rear camera");
        iphone.setCategory("Smart Phone");
        iphone.setManufacturer("Apple");
        iphone.setUnitsInStock(300);

        Product laptop_dell = new Product("P1235", "Dell Inspiron", new BigDecimal(45000));
        laptop_dell.setDescription("Dell Inspiron 14-inch Laptop (Black) with 3rd Generation Intel Core processors");
        laptop_dell.setCategory("Laptop");
        laptop_dell.setManufacturer("Dell");
        laptop_dell.setUnitsInStock(100);

        Product tablet_Nexus = new Product("P1236", "Nexus 7", new BigDecimal(38000));
        ...
        tablet_Nexus.setUnitsInStock(156);
